...
<body>
    ...
    <script type="text/jscript">
        ...
        function LoadPage() {
            ...
            CommonService.GetQueryResult(CountQuery,ConStr, OnSuccessGetTotalPages, OnFailed, CurQuery);
        }
        ...
        function OnSuccessGetTotalPages(result, userContext, eventArgs) {
            ...
            CommonService.GetDynamicTable3(userContext,ConStr, onSuccessCreateTable, OnFailed);
