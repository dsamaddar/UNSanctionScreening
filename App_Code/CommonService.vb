...
Public Function GetBankulatorDate() As String
    ...
    Public Function GetChildData(ByVal tableName As String, ByVal functionName As String, ByVal InputString As String) As String
        ...
        Try
            ...
            ElseIf functionName = "ExecuteQueryAndReturnAll" Then
                OutputString = comDB.ExecuteQueryAndReturnAll(InputString, "Conventional")
    ...
    <WebMethod()> _
    Public Function GetDynamicTable3(ByVal Query As String, ByVal ConStr As String) As String
        Dim str2 As String
        Dim type, tmpID, tmpvalue As String
        Dim tmpdatevalue As DateTime
        Dim i, r As Integer
    ...
    <WebMethod()> _
    Public Function GetQueryResult(ByVal query As String, ByVal ConStr As String) As String
        Dim comDB As New CommonDBSvc
        Dim output As String

        Try
            output = comDB.ExecuteQueryAndReturnAll(query, ConStr)
    ...
    <WebMethod()> _
    Public Function ExecuteQuery(ByVal Query As String, ByVal ConStr As String) As String
        Dim cnStr As String = ConfigurationManager.ConnectionStrings(ConStr).ConnectionString
        Dim con As New SqlConnection(cnStr)
        Try
            Dim cmd As New SqlCommand(Query, con)
