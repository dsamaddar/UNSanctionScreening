...
Public Class CommonDBSvc
    ...
    Public Function GetConnectionString(ByVal ConStr As String) As String
        If ConStr = "Conventional" Then
            Return GlobalVars.cl.cnStringConventional
        Else
            Return GlobalVars.cl.cnStringIslamic
        End If
    ...
    Public Function ExecuteQueryAndReturnAll(ByVal Query As String, ByVal ConStr As String) As String
        Dim cnStr As String = GetConnectionString(ConStr)
        Dim con As New SqlConnection(cnStr)
        Dim retVal As String = ""
        Dim i As Integer = 0
        Try
