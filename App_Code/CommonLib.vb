...
Public Class CommonLib : Inherits System.Web.UI.Page
    ...
    Public cnString, cnStringConventional, cnStringIslamic As String
    ...
    Public Sub New()
        ...
        cnStringConventional = System.Configuration.ConfigurationManager.ConnectionStrings("Conventional").ConnectionString
        cnStringIslamic = System.Configuration.ConfigurationManager.ConnectionStrings("Islamic").ConnectionString
